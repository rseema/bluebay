...
== Description ==
 ...
 In setting option(Fixed header) on dashboard, you can add fixed header background color as wel as your fixed and sticky header text color so it provides enough contrast with regards to the background color.
