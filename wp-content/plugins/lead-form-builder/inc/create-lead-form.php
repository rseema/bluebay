...
function lfb_add_new_form(){
	echo '<div class="wrap">
        ...
        <h2 class="nav-tab-wrapper lfb-nav-tab-wrapper">
            <a class="nav-tab nav-tab-active" href="#">Create From</a>
...
$nonce = wp_create_nonce( '_nonce_verify' );
    ...
    <p class='submit'><input type='submit' class='save_form button-primary' name='save_form' id='save_form' value='Save Form'></p></td>
...
function lfb_form_first_fields() {
    echo "<tr id='form_field_row_1'><td>1</td>
		...
		<input type='button' class='button lf_addnew' name='add_new' id='add_new_1' onclick='add_new_form_fields(1)' value='Add New'>
		</td><input type='hidden' value='1' name='form_field_1[field_id]'>
		</tr>";
}
...
function lfb_form_last_fields(){
       ...
       echo "<tr id='form_field_row_0'><td></td>
          <td><input type='hidden' name='form_field_0[field_name]' id='field_name_0' value='submit'></td>
          <td>
        ...
        </td><input type='hidden' value='0' name='form_field_0[field_id]'>
        </tr>";
}
